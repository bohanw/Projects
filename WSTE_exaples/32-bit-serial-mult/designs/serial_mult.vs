...
logic[31:0] data_ph1, data_ph2, data_ph1_nxt, data_ph2_nxt;
logic corrup_result;

assign data_ph1_nxt = put & (ctrl_ps == W4PUT) ? idata[31:0] : data_ph1; 
assign data_ph2_nxt = put & (ctrl_ps == DATA2) ? idata[31:0] : data_ph2; 
assign corrup_result = ({data_ph1, data_ph2 } == 64'hBADDBADDBADD);
