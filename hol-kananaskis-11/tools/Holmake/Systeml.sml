...
val HOLDIR = "/home/wbh/Downloads/hol-kananaskis-11"
val MOSMLDIR = "/usr/bin"
val HAVE_BASIS2002 = true
val OS = "linux"
val POLY = ""
val POLYC = ""
val POLY_VERSION = 0
...
fun emit_hol_unquote_script target qend _ = let
  val ostrm = TextIO.openOut target
  fun output s = TextIO.output(ostrm, s)
  ...
  val mosml = protect (fullPath [MOSMLDIR, "mosml"])
  val qinit =
      protect (fullPath [HOLDIR, "tools", "unquote-init.sml"])
in
  output "#!/bin/sh\n";
