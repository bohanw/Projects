...
struct
  ...
  fun toWord128 n = fromNum (n,ITSELF(numML.fromInt 128))

  val fromString128 = o(toWord128, numML.fromString) : string -> word128

  type word256 = unit bit0 bit0 bit0 bit0 bit0 bit0 bit0 bit0 word

  fun toWord256 n = fromNum (n,ITSELF(numML.fromInt 256))

  val fromString256 = o(toWord256, numML.fromString) : string -> word256
