...
(*
   ...
   [ALL_DISTINCT_MEM_ZIP_MAP]  Theorem
      ...
      |- ∀f x ls.
           ALL_DISTINCT ls ⇒
           (MEM x (ZIP (ls,MAP f ls)) ⇔
            MEM (FST x) ls ∧ (SND x = f (FST x)))
   ...
   [TAKE_EL_SNOC]  Theorem
      ...
      |- ∀ls n.
           n < LENGTH ls ⇒ (TAKE (n + 1) ls = SNOC (EL n ls) (TAKE n ls))
