...
(*
   ...
   [canonical_sum_case_def]  Definition
      ...
      |- (∀v f f1. canonical_sum_CASE Nil_monom v f f1 = v) ∧
         ...
         ∀a0 a1 v f f1.
           canonical_sum_CASE (Cons_varlist a0 a1) v f f1 = f1 a0 a1
      ...
      |- canonical_sum_merge_tupled =
         WFREC
           ...
           (λcanonical_sum_merge_tupled a.
              ...
              | (sr,Nil_monom,Cons_monom c2 l2 t2) =>
                  I (Cons_monom c2 l2 t2)
              | (sr,Cons_monom c1 l1 t1,Cons_monom c2 l2 t2) =>
                  I
              ...
              | (sr,Nil_monom,Cons_varlist l2' t2') =>
                  I (Cons_varlist l2' t2')
              | (sr,Cons_monom c1' l1' t1',Cons_varlist l2' t2') =>
                  I
                    (compare (list_compare index_compare l1' l2')
                       (Cons_monom c1' l1'
   ...
   [canonical_sum_size_def]  Definition
      ...
      |- (∀f. canonical_sum_size f Nil_monom = 0) ∧
         (∀f a0 a1 a2.
            ...
            1 +
            (f a0 + (list_size index_size a1 + canonical_sum_size f a2))) ∧
         ∀f a0 a1.
   ...
   [interp_m_def]  Definition
      ...
      |- (∀sr vm c. interp_m sr vm c [] = c) ∧
         ∀sr vm c x t.
           interp_m sr vm c (x::t) = sr.SRM c (ivl_aux sr vm x t)
   ...
   [spolynom_case_def]  Definition
      ...
      |- (∀a f f1 f2 f3. spolynom_CASE (SPvar a) f f1 f2 f3 = f a) ∧
         ...
         (∀a0 a1 f f1 f2 f3.
            spolynom_CASE (SPplus a0 a1) f f1 f2 f3 = f2 a0 a1) ∧
         ∀a0 a1 f f1 f2 f3.
           spolynom_CASE (SPmult a0 a1) f f1 f2 f3 = f3 a0 a1

   [spolynom_normalize_def]  Definition

      |- (∀sr i.
            spolynom_normalize sr (SPvar i) = Cons_varlist [i] Nil_monom) ∧
         (∀sr c.
   ...
   [varlist_insert_tupled_primitive_def]  Definition
      ...
      |- varlist_insert_tupled =
         WFREC
           (@R.
              WF R ∧
              (∀l2 c2 t2 l1 sr. R (sr,l1,t2) (sr,l1,Cons_monom c2 l2 t2)) ∧
   ...
   [ivl_aux_ok]  Theorem
      ...
      |- ∀sr.
           ...
           ∀vm v i.
             ivl_aux sr vm i v =
             sr.SRM (varmap_find i vm) (interp_vl sr vm v)
