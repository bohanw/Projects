...
Maximum resident size            =  6676K

Virtual memory limit             = unlimited (unlimited)
Major page faults = 0
Minor page faults = 1052
Swaps = 0
Input blocks = 8
Output blocks = 8
Context switch (voluntary) = 1
Context switch (involuntary) = 36
